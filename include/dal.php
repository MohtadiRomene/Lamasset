...
class tDAL
{
	var $tbllamassetbeautyappatlocalhost__beauty_centers;
	var $tbllamassetbeautyappatlocalhost__categories;
	var $tbllamassetbeautyappatlocalhost__opening_hours;
	var $tbllamassetbeautyappatlocalhost__password_resets;
	var $tbllamassetbeautyappatlocalhost__reservations;
	var $tbllamassetbeautyappatlocalhost__reviews;
	var $tbllamassetbeautyappatlocalhost__services;
	var $tbllamassetbeautyappatlocalhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "beauty_centers", "varname" => "lamassetbeautyappatlocalhost__beauty_centers", "altvarname" => "beauty_centers", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
		$this->lstTables[] = array("name" => "categories", "varname" => "lamassetbeautyappatlocalhost__categories", "altvarname" => "categories", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
		$this->lstTables[] = array("name" => "opening_hours", "varname" => "lamassetbeautyappatlocalhost__opening_hours", "altvarname" => "opening_hours", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
		$this->lstTables[] = array("name" => "password_resets", "varname" => "lamassetbeautyappatlocalhost__password_resets", "altvarname" => "password_resets", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
		$this->lstTables[] = array("name" => "reservations", "varname" => "lamassetbeautyappatlocalhost__reservations", "altvarname" => "reservations", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
		$this->lstTables[] = array("name" => "reviews", "varname" => "lamassetbeautyappatlocalhost__reviews", "altvarname" => "reviews", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
		$this->lstTables[] = array("name" => "services", "varname" => "lamassetbeautyappatlocalhost__services", "altvarname" => "services", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
		$this->lstTables[] = array("name" => "users", "varname" => "lamassetbeautyappatlocalhost__users", "altvarname" => "users", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
	}
