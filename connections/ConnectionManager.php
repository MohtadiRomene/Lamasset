...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "lamassetbeautyappatlocalhost";
		$data["connName"] = "lamasset_beauty_app at localho";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;lamasset_beauty_app;;1"; //currently unused

		$this->_connectionsIdByName["lamasset_beauty_app at localho"] = "lamassetbeautyappatlocalhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "lamasset_beauty_app";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=lamasset_beauty_app;OPTION=3";
		// encription set
		...
		$connectionsData["lamassetbeautyappatlocalhost"] = $data;
