...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "lamassetbeautyappatlocalhost" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["beauty_centers"] = "lamassetbeautyappatlocalhost";
		$connectionsIds["categories"] = "lamassetbeautyappatlocalhost";
		$connectionsIds["reservations"] = "lamassetbeautyappatlocalhost";
		$connectionsIds["services"] = "lamassetbeautyappatlocalhost";
		$connectionsIds["users"] = "lamassetbeautyappatlocalhost";
		$connectionsIds["opening_hours"] = "lamassetbeautyappatlocalhost";
