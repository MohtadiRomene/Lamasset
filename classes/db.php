...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "lamassetbeautyappatlocalhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "beauty_centers", "varname" => "lamassetbeautyappatlocalhost__beauty_centers", "altvarname" => "beauty_centers", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
			$dalTables[$conn->connId][] = array("name" => "categories", "varname" => "lamassetbeautyappatlocalhost__categories", "altvarname" => "categories", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
			$dalTables[$conn->connId][] = array("name" => "opening_hours", "varname" => "lamassetbeautyappatlocalhost__opening_hours", "altvarname" => "opening_hours", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
			$dalTables[$conn->connId][] = array("name" => "password_resets", "varname" => "lamassetbeautyappatlocalhost__password_resets", "altvarname" => "password_resets", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
			$dalTables[$conn->connId][] = array("name" => "reservations", "varname" => "lamassetbeautyappatlocalhost__reservations", "altvarname" => "reservations", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
			$dalTables[$conn->connId][] = array("name" => "reviews", "varname" => "lamassetbeautyappatlocalhost__reviews", "altvarname" => "reviews", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
			$dalTables[$conn->connId][] = array("name" => "services", "varname" => "lamassetbeautyappatlocalhost__services", "altvarname" => "services", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "lamassetbeautyappatlocalhost__users", "altvarname" => "users", "connId" => "lamassetbeautyappatlocalhost", "schema" => "", "connName" => "lamasset_beauty_app at localho");
		}
	}
