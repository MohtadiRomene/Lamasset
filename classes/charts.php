...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("beauty_centers" == $this->chrt_array['tables'][0])
			return true;
		if("categories" == $this->chrt_array['tables'][0])
			return true;
		if("reservations" == $this->chrt_array['tables'][0])
			return true;
		if("services" == $this->chrt_array['tables'][0])
			return true;
		if("users" == $this->chrt_array['tables'][0])
			return true;
		if("opening_hours" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
