...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "lamassetbeautyappatlocalhost";
		}
		return $connId;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "beauty_centers" ] = array( "url" => "beauty_centers", "type" => 0 );
	$projectEntitiesReverse[ "beauty_centers" ] = "beauty_centers";
	$projectEntities[ "categories" ] = array( "url" => "categories", "type" => 0 );
	$projectEntitiesReverse[ "categories" ] = "categories";
	$projectEntities[ "reservations" ] = array( "url" => "reservations", "type" => 0 );
	$projectEntitiesReverse[ "reservations" ] = "reservations";
	$projectEntities[ "services" ] = array( "url" => "services", "type" => 0 );
	$projectEntitiesReverse[ "services" ] = "services";
	$projectEntities[ "users" ] = array( "url" => "users", "type" => 0 );
	$projectEntitiesReverse[ "users" ] = "users";
	$projectEntities[ "opening_hours" ] = array( "url" => "opening_hours", "type" => 0 );
	$projectEntitiesReverse[ "opening_hours" ] = "opening_hours";
}
